...
class Calendar extends Component {
  state = {
    dateContext: this.props.currentDate,
    today: moment(),
    ...
    return (
      <div className="calendar-container" style={this.style}>
        <table className="calendar">
          ...
          <tfoot>
            <tr className='calendar-footer'>
              <td colSpan="7"> <label className='selectTime-label mr-2' htmlFor="selectTime">Select Time</label>
              <button id="selectTime" type="button" className="btn btn-sm btn-secondary" onClick={() => this.props.onButtonClick(this.state.dateContext)}>
                OK
              </button></td>
